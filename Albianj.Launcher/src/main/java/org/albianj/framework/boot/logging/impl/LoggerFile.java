...
import org.albianj.framework.boot.timer.impl.TimerServant;
...
public class LoggerFile implements Closeable {
    ...
    public LoggerFile(String logName, String path, String maxFilesize) {
        ...
        String filename = StringServant.Instance.join(path, logName, "_", DailyServant.Instance.datetimeLongStringWithoutSep(), ".log");
        try {
