...
public class TimerWheel implements ITimer {
    ...
    public TimerWheel() {
        this(ApplicationContext.Instance.findCurrentBundleContext(TimerWheel.class,false));
    }

    public TimerWheel(long loopTimestamp, TimeUnit unit) {
        this(ApplicationContext.Instance.findCurrentBundleContext(TimerWheel.class,false), loopTimestamp, unit);
    }

    public TimerWheel(long loopTimestamp, TimeUnit unit, int wheelCount) {
        this(ApplicationContext.Instance.findCurrentBundleContext(TimerWheel.class,false), loopTimestamp, unit, wheelCount);
    }
...
//        }
        ...
        if(null != ctx) {
            ...
            workerThread = new Thread( worker,"TimerWheel");
